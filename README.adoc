...
The latest version of the recipe book can be found here, rendered by GitHub:
https://suse.github.io/recipebook/recipes.html

A nicer version should appear here after changes are merged, rendered by asciidoctor:
https://opensource.suse.com/recipebook/recipes.html
